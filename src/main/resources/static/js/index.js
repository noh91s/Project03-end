...
function highlightCurrentMenuExpanded() {
    ...
    if (hightlightTargetMenu) {
        ...
        if (highlightImage && imgTag && spanTag) {
            ...
            imgTag.style.filter = 'invert(30%) sepia(100%) saturate(740%) hue-rotate(355deg) brightness(86%) contrast(88%)';
            spanTag.style.color = '#DC2424';
            spanTag.style = 'color:  #DC2424; font-weight: bold';
